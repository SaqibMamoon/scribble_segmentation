...
import acdc_data_crf_pro as acdc_data
...
from experiments import prostate_dropout_crf_dif_exp as exp_config
...
#            saver.restore(sess,'/scratch_net/biwirender02/cany/scribble/logdir/heart_residual_crf/recursion_0_model_best_dice.ckpt-14199')
            ...
            saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/prostate_deep_dropout_dif_exp/recursion_0_model_best_dice.ckpt-8199")
#            
            init_step=10000
            start_epoch = 0
            recursion=1
...
#                         .format(ind[0], ind[-1]))
            ...
            logs = sess.run(tf.nn.softmax(temp_mean))
            ...
            mask_out = np.uint(apply_crf(logs,x))
