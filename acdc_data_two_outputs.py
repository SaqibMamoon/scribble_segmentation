...
def create_recursion_dataset(target_folder, recursion):
    ...
    new_data_file.create_dataset('predicted_pre_crf', dtype='float', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],5))
    ...
    new_data_file.create_dataset('network_output', dtype='float', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],5))
    new_data_file['network_output'].attrs.create('processed', False, dtype='bool')
    new_data_file['network_output'].attrs.create('processed_to', 0, dtype='uint16')
