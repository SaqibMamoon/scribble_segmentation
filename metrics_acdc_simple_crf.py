# -*- coding: utf-8 -*-
"""
Created on Sat Apr  7 21:58:24 2018
...
def main(path_gt, path_pred, eval_dir, parameters, printing=False):
    """
    ...
    if os.path.isdir(path_gt) and os.path.isdir(path_pred):
        ...
        text_file = open("crf_grid_search.txt", "a")
          
        text_file.write("\nParameters :  " + " : "+str(parameters) )
 
        text_file.write('\n------------Average Dice Figures----------')
        ...
        text_file.write('\nDice 3: %f' % dice3)
        text_file.write('\nMean dice: %f' % np.mean([dice1, dice2, dice3]))
...
if __name__ == "__main__":
    ...
    parser.add_argument("PARAMETERS", type=str, help="path to output directory", default='.')
    args = parser.parse_args()
    main(args.GT_IMG, args.PRED_IMG, args.EVAL_DIR,args.PARAMETERS)
