...
from experiments import network_crf_exp as exp_config
...
#                         .format(ind[0], ind[-1]))
            ...
            mask_out = sess.run(softmax, feed_dict=feed_dict)
            mask_out = apply_crf(mask_out,x)
            #save to dataset
