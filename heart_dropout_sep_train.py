...
from experiments import heart_dropout_sep_exp as exp_config
...
#                saver.restore(sess, init_checkpoint_path)
            saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/heart_dropout_two_welch_exp/recursion_0_model_best_dice.ckpt-19699")
...
def predict_next_gt(data,
    ...
    if not processed:
        ...
        for scr_idx in range(processed_to, scr_max, exp_config.batch_size):
            ...
            mask = tf.arg_max(logits, dimension=-1)      
