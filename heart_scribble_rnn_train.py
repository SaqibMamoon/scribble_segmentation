...
from experiments import heart_rnn_exp as exp_config
...
#                saver.restore(sess, init_checkpoint_path)
            saver.restore(sess,'/scratch_net/biwirender02/cany/scribble/logdir/heart_rnn_dif_exp/recursion_0_model_best_dice.ckpt-24199')
##        
