...
def create_recursion_dataset(target_folder, recursion):
    ...
    new_data_file.create_dataset('p_vals', dtype='float32', shape=base_data_file['scribbles_train'].shape)
    new_data_file['p_vals'].attrs.create('processed', False, dtype='bool')
    new_data_file['p_vals'].attrs.create('processed_to', 0, dtype='uint16')

    new_data_file.create_dataset('means', dtype='float32', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],5))
