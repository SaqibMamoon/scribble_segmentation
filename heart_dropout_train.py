...
from experiments import heart_residual_dropout_exp as exp_config
...
#                saver.restore(sess, init_checkpoint_path)
            saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/heart_residual_dropout_exp/recursion_0_model_best_dice.ckpt-17499")
