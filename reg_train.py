...
from experiments import twisted_full_exp as exp_config
...
#                    crf_weights_name.append(v.name)
            ...
            crf_train_op = tf.train.AdamOptimizer(learning_rate=crf_learning_rate_placeholder).minimize(loss + 0.0001*reg_loss,var_list=crf_variables,
                                                                                         colocate_gradients_with_ops=True,
                                                                                         global_step=global_step)
