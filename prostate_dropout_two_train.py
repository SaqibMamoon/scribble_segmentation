...
from experiments import prostate_new_dropout_two_exp as exp_config
...
#        with tf.Graph().as_default():
        with tf.Session(config = config) as sess:
            ...
            [network_output,logits] = model.inference(images_placeholder,
                                     keep_prob,
    ...
    if not processed:
        ...
        for scr_idx in range(processed_to, scr_max, exp_config.batch_size):
            ...
            for k in range(50):
                ...
                temp[k,:,:,:,:] = sess.run(network_output,feed_dict=feed_dict)
