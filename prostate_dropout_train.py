...
import acdc_data_welch_pro as acdc_data
...
#                saver.restore(sess, init_checkpoint_path)
            ...
            saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/prostate_deep_dropout_dif_exp/recursion_1_model.ckpt-10899")
#
            ...
            step = init_step
            curr_lr = exp_config.learning_rate/15
    ...
    if not processed:
        ...
        for scr_idx in range(processed_to, scr_max, exp_config.batch_size):
            ...
            for indice in range(len(ind)):
                ...
                means_h[ind[indice], ...] = np.squeeze(means[indice, ...])
