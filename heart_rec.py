...
if __name__ == '__main__':
    ...
    model_path = '/scratch_net/biwirender02/cany/scribble/logdir/heart_rnn_residual_exp'
    ...
    net_out = model.predict_net_out(images_pl, exp_config.model_handle, exp_config.nlabels)
    ...
    with tf.Session() as sess:
        ...
        sess.run(init)
        saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/heart_rnn_residual_exp/high_crf_lr/recursion_0_model_best_dice.ckpt-13699")
