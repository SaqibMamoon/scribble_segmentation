...
from experiments import heart_dropout_fixed_rnn_exp as exp_config
...
#        with tf.Graph().as_default():
        with tf.Session(config = config) as sess:
            ...
            load_saver = tf.train.Saver(var_list=crf_variables)
...
#            saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/heart_dropout_rnn_exp/recursion_1_model_best_dice.ckpt-12699")
            load_saver.restore(sess, '/scratch_net/biwirender02/cany/scribble/logdir/heart_dropout_fixed_rnn_exp/recursion_0_model_best_dice.ckpt-22699')
