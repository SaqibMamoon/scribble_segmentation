...
from experiments import no_cnn_thresh_full_only_initial_rw as exp_config
...
#                    crf_weights_name.append(v.name)
            ...
            crf_train_op = tf.train.AdamOptimizer(learning_rate=crf_learning_rate_placeholder).minimize(loss,
                                                                                         colocate_gradients_with_ops=True,
                                                                                         global_step=global_step)
