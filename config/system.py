...
project_root = '/scratch_net/biwirender02/cany/scribble/'
data_root = '/scratch_net/biwirender02/cany/acdc/data/'
#data_root = '/scratch_net/biwirender02/cany/scribble/scribble_data/'
local_hostname = 'biwirender02'  # used to check if on cluster or not
test_data_root = '/scratch_net/bmicdl03/sharing/ACDC_challenge_testdata'
##################################################################################
