...
project_root = '/scratch_net/biwirender02/cany/acdc/'
data_root = '/scratch_net/biwirender02/cany/acdc/data/'
test_data_root = '/scratch_net/biwirender02/cany/acdc/test_data/'
local_hostnames = ['biwirender02']  # used to check if on cluster or not,
