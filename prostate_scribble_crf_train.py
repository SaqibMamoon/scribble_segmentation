...
from experiments import prostate_scribble_full_crf as exp_config
...
#                saver.restore(sess, init_checkpoint_path)
            saver.restore(sess,'/scratch_net/biwirender02/cany/scribble/logdir/prostate_scribble_full_deep_crf/recursion_1_model_best_dice.ckpt-9199')
