...
def create_recursion_dataset(target_folder, recursion):
    ...
    new_data_file.create_dataset('predicted_pre_crf', dtype='uint8', shape=base_data_file['scribbles_train'].shape)
    new_data_file['predicted_pre_crf'].attrs.create('processed', False, dtype='bool')
    new_data_file['predicted_pre_crf'].attrs.create('processed_to', 0, dtype='uint16')
    
    new_data_file.create_dataset('pre_logits', dtype='float32', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],4))
    new_data_file['pre_logits'].attrs.create('processed', False, dtype='bool')
    new_data_file['pre_logits'].attrs.create('processed_to', 0, dtype='uint16')
    
    
    new_data_file.create_dataset('logits', dtype='float32', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],4))
    new_data_file['logits'].attrs.create('processed', False, dtype='bool')
    new_data_file['logits'].attrs.create('processed_to', 0, dtype='uint16')
