...
import utils
import image_utils
import model_pro_full_sup as model
...
from experiments import prostate_full_sup_unet_base as exp_config
...
#            saver.restore(sess,'/scratch_net/biwirender02/cany/scribble/logdir/prostate_scribble_full_deep_base/recursion_1_model_best_dice.ckpt-6899')
##      
#            saver.restore(sess,'/scratch_net/biwirender02/cany/scribble/logdir/prostate_full_sup_unet_base/recursion_0_model_best_dice.ckpt-8799')
##          
            init_step=0
            start_epoch = 0
            recursion = 0
