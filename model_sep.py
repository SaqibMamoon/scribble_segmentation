...
def predict_final(images, net_out, nlabels):
    ...
    net_output = model_zoo.seperate_crf_rnn(net_out,images, nlabels)
...
def predict_net_out(images, keep_prob,inference_handle, nlabels):
    ...
    net_output = model_zoo.seperate_net(images, tf.constant(False, dtype=tf.bool), nlabels,keep_prob)
