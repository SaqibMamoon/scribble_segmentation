...
def create_recursion_dataset(target_folder, recursion):
    ...
    new_data_file.create_dataset('means', dtype='float', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],4))
    new_data_file['means'].attrs.create('processed', False, dtype='bool')
    new_data_file['means'].attrs.create('processed_to', 0, dtype='uint16')

    new_data_file.create_dataset('stds', dtype='float', shape=(base_data_file['scribbles_train'].shape[0],base_data_file['scribbles_train'].shape[1],base_data_file['scribbles_train'].shape[2],4))
