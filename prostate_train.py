...
from experiments import prostate_full_rw90_new_exp as exp_config
...
def do_eval(sess,
    ...
    return avg_loss, avg_dice, np.asarray(all_pred), np.asarray(all_labels), dices
