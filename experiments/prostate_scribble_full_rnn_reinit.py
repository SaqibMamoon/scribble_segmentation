...
experiment_name = 'prostate_scribble_full_rnn_reinit'

# Model settings
model_handle = model_zoo.prostate_new_crf

# Data settings
data_mode = '2D'  # 2D or 3D
image_size = (320, 320)
target_resolution = (1.36719, 1.36719)
scribble_data = '/scribble_data/prostate_divided_normalized.h5'        #Path from project root
...
reinit = True                  # if true, will reinitialise network weights between recursions
