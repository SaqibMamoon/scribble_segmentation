...
import model_zoo_base as model_zoo
import tensorflow as tf

experiment_name = 'heart_dropout_welch_non_exp2'

# Model settings
model_handle = model_zoo.unet2D_bn_dropout

# Data settings
data_mode = '2D'  # 2D or 3D
image_size = (212, 212)
target_resolution = (1.36719, 1.36719)
scribble_data = '/scribble_data/scribble_data.hdf5'        #Path from project root
