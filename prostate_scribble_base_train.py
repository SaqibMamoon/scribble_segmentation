...
from experiments import prostate_scribble_full_deep_base as exp_config
...
#                saver.restore(sess, init_checkpoint_path)
            saver.restore(sess,'/scratch_net/biwirender02/cany/scribble/logdir/prostate_scribble_full_deep_base/recursion_0_model_best_dice.ckpt-5099')
            ...
            for epoch in range(start_epoch, exp_config.max_epochs):
                if (epoch % exp_config.epochs_per_recursion == 0 and epoch != 0):
                    ...
                    recursion_data = predict_next_gt(data=recursion_data,
                                                     ...
                                                     logits=logits,
                                                     sess=sess,random_walked=random_walked)
