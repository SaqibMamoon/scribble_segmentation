...
import config.acdc_system as sys_config
import acdc_data
...
from experiments import heart_full_sup_rnn_exp as exp_config
...
#        with tf.Graph().as_default():
    with tf.Session(config = config) as sess:
        ...
        logits = model.inference(images_placeholder, exp_config, training=training_time_placeholder)
