...
from experiments import heart_dropout_rnn_mean_net as exp_config
...
#                saver.restore(sess, init_checkpoint_path)
            saver.restore(sess,"/scratch_net/biwirender02/cany/scribble/logdir/heart_dropout_rnn_mean_net/recursion_1_model_best_dice.ckpt-40399")
